...
const TranscriptDisplay: FC<TranscriptDisplayProps> = ({ 
  ...
  return (
    <div className="grid grid-cols-2 gap-8 min-h-[500px] my-8">
      <div className="border rounded-lg p-8 bg-white shadow-sm hover:shadow-md transition-shadow">
        <h2 className="text-2xl font-bold mb-8 text-gray-800 pb-2 border-b">Original</h2>
      ...
      <div className="border rounded-lg p-8 bg-white shadow-sm hover:shadow-md transition-shadow">
        <h2 className="text-2xl font-bold mb-8 text-gray-800 pb-2 border-b">Translated</h2>
        <div className="space-y-6 max-h-[600px] overflow-y-auto pr-4">
          {transcripts.map((t) => (
